...
def _seed_algorithm_updates():
    ...
    updates = [
        ...
        {'update_name': 'January 2025 Helpful Content Update', 'update_date': '2025-01-15', 'update_type': 'helpful-content', 'severity': 'major', 'description': 'Continued refinements to helpful content system'},
    ...
    for u in updates:
        update = AlgorithmUpdate(
            ...
            update_date=datetime.date.fromisoformat(u['update_date']),
